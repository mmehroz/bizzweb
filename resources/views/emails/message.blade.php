				...
				<div class="container">
					<!-- <div class="account-box"> -->
						<div class="account-wrapper">
                            ...
                            <p style="margin: 0; color: #000;margin-bottom: 10px;"><span style="color: #85152d; font-weight: bold; padding-right: 27px;">Name </span> {{$request->name}}</p>
                            <p style="margin: 0; color: #000;margin-bottom: 10px;"><span style="color: #85152d; font-weight: bold; padding-right: 27px;">Email </span> {{$request->email}}</p>
                            <p style="margin: 0; color: #000;"><span style="color: #85152d; font-weight: bold;; padding-right: 5px;">Message</span> {{$request->usermessage}}</p>
							            </td>
							          </tr>
							          <tr>
