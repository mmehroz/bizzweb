...
!(function ($) {
  ...
  $.fn.onepage_scroll = function (options) {
    ...
    $.fn.transformPage = function (settings, pos, index) {
      ...
      if ($("html").hasClass("ie8")) {
        ...
        if ($("body").hasClass("viewing-page-1")) {
          ...
          $("#canvas1 , .section-1-border-bottom").css({
            opacity: "0",
          });
          //
          if ($(".section-4 .first-video").html() == "!") {
            $(".section-4 .first-video").html(
              '<iframe src="https://www.youtube.com/embed/CYq22PTicJg" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
            );
            $(".section-4 .second-video").html(
              '<iframe src="https://www.youtube.com/embed/awed6s6K3MA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
            );
          } else {
          }
        }
        ...
        $(this).css({
          "-webkit-transform":
            settings.direction == "horizontal"
              ? "translate3d(" + pos + "%, 0, 0)"
              : "translate3d(0, " + pos + "%, 0)",
          "-webkit-transition": "all " + +"ms " + settings.easing,
          "-moz-transform":
            settings.direction == "horizontal"
              ? "translate3d(" + pos + "%, 0, 0)"
              : "translate3d(0, " + pos + "%, 0)",
    ...
    //
    $("#menu-home-link").click(function () {
      el.moveTo(1);
      closeMenu();
    });
    $("#menu-services-link").click(function () {
      el.moveTo(2);
      closeMenu();
    });
    $("#menu-videos-link").click(function () {
      el.moveTo(3);
      closeMenu();
    });
    $("#menu-our-leaders-link").click(function () {
      el.moveTo(4);
      closeMenu();
    });
    $("#menu-job-link").click(function () {
      el.moveTo(5);
      closeMenu();
    });
