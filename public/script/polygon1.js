function canvasAnimation(ahm_canvas, ahm_color, ahm_distance, ahm_radius) {
  var t = document.querySelector(ahm_canvas),
    o = t.getContext("2d");
  (t.width = window.innerWidth),
    (t.height = window.innerHeight),
    (o.lineWidth = 0.5),
    (o.strokeStyle = new y(150).style);
  var n = {
      x: t.width / 2,
      y: t.height / 2,
    },
  ...
  function h(i, t, o) {
    return !0 === a ? "rgba(0,0,0, 0.8)" : ahm_color;
  }
...
$(document).ready(function () {
  if (!($(window).width() < 500)) {
    canvasAnimation("#canvas1", "rgba(250, 166, 30, 0.356)", 100, 150);
    canvasAnimation("#canvas2", "rgba(225, 0,0,.3)", 100, 150);
    canvasAnimation("#canvas3", "rgba(255, 255, 255,.15)", 100, 150);
  }
}),
